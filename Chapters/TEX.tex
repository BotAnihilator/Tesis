...
\lhead{Chapter 1. \emph{LHC}} % This is for the header on each page - perhaps a shortened title
...
\subsection{Electron cloud due to beam induced synchrotron radiation}
